...
class Struct8T<A, B, C, D, E, F, G, H> private constructor(
  name: String,
  val member1: Field<A>,
...
) : StructT<Struct8<A, B, C, D, E, F, G, H>>(
    name,
    member1,
    member2,
    member3,
  ...
  override fun encode(value: Struct8<A, B, C, D, E, F, G, H>): ByteArray =
  ...
  override fun decode(bytes: Slice): Pair<Struct8<A, B, C, D, E, F, G, H>, Slice> =
            ...
            member5.decodeValue(remainingD, Struct4(a, b, c, d), this).let { (e, remainingE) ->
              member6.decodeValue(remainingE, Struct5(a, b, c, d, e), this).let { (f, remainingF) ->
                member7.decodeValue(remainingF, Struct6(a, b, c, d, e, f), this).let { (g, remainingG) ->
                  member8.decodeValue(remainingG, Struct7(a, b, c, d, e, f, g), this).let { (h, remaining) ->
                    Struct8(a, b, c, d, e, f, g, h) to remaining
                  }
                }
              }
            }
  ...
  fun create(
    ...
    field7: G,
    field8: H,
  ): Struct8<A, B, C, D, E, F, G, H> = Struct8(field1, field2, field3, field4, field5, field6, field7, field8)

  class Builder<A, B, C, D, E, F, G, H>
    @PublishedApi
    internal constructor(
    ...
    ) : StructBuilder<Struct8<A, B, C, D, E, F, G, H>, Struct8T<A, B, C, D, E, F, G, H>>() {
      override val nextIndex: UInt = 8U

      fun <I> field(
        fieldName: String,
        type: DataType<I>,
      ): Struct9T.Builder<A, B, C, D, E, F, G, H, I> =
        Struct9T.Builder(
          name,
      ...
      inline fun <I, reified _E> select(
        enumT: EnumT<_E>,
        fieldName: String,
        vararg nestedPath: String,
        crossinline block: SelectBuilder<I, _E>.() -> SelectBuilder<I, _E>,
      ): Struct9T.Builder<A, B, C, D, E, F, G, H, I> where _E : ProtocolEnum<_E> =
        Struct9T.Builder(
          name, member1, member2, member3, member4, member5, member6, member7, member8,
          createSelect(enumT, fieldName, *nestedPath, block = block),
        )

      @PublishedApi override fun buildStructT(): Struct8T<A, B, C, D, E, F, G, H> =
        Struct8T(name, member1, member2, member3, member4, member5, member6, member7, member8)
    }

  interface Shape<out A, out B, out C, out D, out E, out F, out G, out H> {

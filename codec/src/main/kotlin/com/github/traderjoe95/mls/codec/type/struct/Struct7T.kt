...
class Struct7T<A, B, C, D, E, F, G> private constructor(
  name: String,
  val member1: Field<A>,
...
) : StructT<Struct7<A, B, C, D, E, F, G>>(name, member1, member2, member3, member4, member5, member6, member7) {
  context(Raise<EncoderError>)
  override fun encode(value: Struct7<A, B, C, D, E, F, G>): ByteArray =
  ...
  override fun decode(bytes: Slice): Pair<Struct7<A, B, C, D, E, F, G>, Slice> =
          ...
          member4.decodeValue(remainingC, Struct3(a, b, c), this).let { (d, remainingD) ->
            member5.decodeValue(remainingD, Struct4(a, b, c, d), this).let { (e, remainingE) ->
              member6.decodeValue(remainingE, Struct5(a, b, c, d, e), this).let { (f, remainingF) ->
                member7.decodeValue(remainingF, Struct6(a, b, c, d, e, f), this).let { (g, remaining) ->
                  Struct7(a, b, c, d, e, f, g) to remaining
                }
              }
            }
          }
  ...
  fun create(
    ...
    field6: F,
    field7: G,
  ): Struct7<A, B, C, D, E, F, G> = Struct7(field1, field2, field3, field4, field5, field6, field7)

  class Builder<A, B, C, D, E, F, G>
    @PublishedApi
    internal constructor(
    ...
    ) : StructBuilder<Struct7<A, B, C, D, E, F, G>, Struct7T<A, B, C, D, E, F, G>>() {
      override val nextIndex: UInt = 7U

      fun <H> field(
        fieldName: String,
        type: DataType<H>,
      ): Struct8T.Builder<A, B, C, D, E, F, G, H> =
        Struct8T.Builder(
          name,
          member1, member2, member3, member4, member5, member6, member7, createField(fieldName, type),
        )
      ...
      fun <H> field(
        ...
        Struct8T.Builder(
          name,
          member1, member2, member3, member4, member5, member6, member7, createField(fieldName, type, constant.some()),
        )

      context(Raise<SelectError>)
      inline fun <H, reified _E> select(
        enumT: EnumT<_E>,
        fieldName: String,
        vararg nestedPath: String,
        crossinline block: SelectBuilder<H, _E>.() -> SelectBuilder<H, _E>,
      ): Struct8T.Builder<A, B, C, D, E, F, G, H> where _E : ProtocolEnum<_E> =
        Struct8T.Builder(
          name, member1, member2, member3, member4, member5, member6, member7,
          createSelect(enumT, fieldName, *nestedPath, block = block),
        )

      @PublishedApi override fun buildStructT(): Struct7T<A, B, C, D, E, F, G> =
        Struct7T(name, member1, member2, member3, member4, member5, member6, member7)
    }

  interface Shape<out A, out B, out C, out D, out E, out F, out G> {
